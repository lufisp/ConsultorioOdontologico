   ...
   private static final long serialVersionUID = 1L;
    ...
    public List<Imagem> getImagensOfOrcamento(int idOrcamento){
        return getPureList(Imagem.class,"select new br.com.devmedia.consultorioee.entities.Imagem("
                + "img.imgId,img.imgDescricao, img.imgdataInclusao, img.imghoraInclusao,img.imgCategoria,img.imgOrcamento) "
                + "from Imagem img where img.imgOrcamento.orcId = ?1",idOrcamento);
    }
}
